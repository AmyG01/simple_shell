...
/**
 * get_builtin - Matches the command with the corresponding
...
/**
 * shellby_cd - Change of the current directory of the shellby process.
...
/**
 * shellby_help - It displays information about shellby builtin commands.
 * @args: Array of arguments.
