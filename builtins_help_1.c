...
/**
 * help_alias - It displays information on the shellby builtin using command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - It displays information on the shellby builtin using command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - It displays information on the shellby builtin using command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shellby builtin using command 'help'.
 */
void help_help(void)
{
